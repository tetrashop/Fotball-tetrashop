...
```bash
git clone https://github.com/tetrashop/Fotball-tetrashop.git
cd Fotball-tetrashop
# دستورات نصب
```
...
- **URL:** [  🚀 دیپلوی Fotball-tetrashop روی Vercel...
    ❌ دیپلوی ناموفق!
...
Vercel CLI 58.5.1 (Node.js 26.4.0)
  ...
  Directory       ~/github/Fotball-tetrashop
...
Learn More: https://vercel.com/docs/projects/overview#project-name](  🚀 دیپلوی Fotball-tetrashop روی Vercel...
    ❌ دیپلوی ناموفق!
error: "/data/data/com.termux/files/usr/lib/node_modules/vercel/dist/get-latest-worker.cjs" has bad ELF magic: 2f2a2a0a
Vercel CLI 58.5.1 (Node.js 26.4.0)
...
- **وضعیت:** ✅ فعال
- **آخرین به‌روزرسانی:** 2026-08-15 18:10
...
<!-- Trigger deploy: Mon Aug 17 01:47:46 +0330 2026 -->

## 🌐 دیپلوی

- **URL:** [https://Fotball-tetrashop.vercel.app](https://Fotball-tetrashop.vercel.app)
- **وضعیت:** ✅ فعال
